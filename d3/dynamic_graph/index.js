...
import isNeighborLink from './utils/isNeighborLink.js'

import baseNodes from './data/nodes.js'
import baseLink from './data/links.js'
...
function selectNode(selectedNode) {
  ...
  const neighbors = getNeighbors(selectedNode, baseLink)
...
function updateData(selectedNode) {
  ...
  links = baseLink.filter(link => link.target.id === selectedNode.id || link.source.id === selectedNode.id)
}
